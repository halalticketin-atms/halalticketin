...
export const cancelEvent = async (
  ...
  assertValidEventId(eventId);
  return api.post<{ event: EventRecord; refunds?: unknown }>(
...
export const fetchPublicEvents = async (options?: {
  limit?: number;
  offset?: number;
  organizerId?: string;
}) => {
  ...
  return api.get<{ events: PublicEventRecord[]; total?: number; hasMore: boolean }>(
